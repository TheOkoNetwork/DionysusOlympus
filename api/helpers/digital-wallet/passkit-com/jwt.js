...
module.exports = {
  ...
  friendlyName: 'digital-wallet/passkit-com/jwt',


  description: 'Generates a JWT for PassKit.com API',
  ...
  sync: true,
  fn: function () {
    return generateJWT(process.env.PASSKIT_COM_KEY, process.env.PASSKIT_COM_SECRET);
  }
